  ...
  return (
    <div className="w-full appear-smooth mt-16">
      ...
      <div className="mt-4 mx-3 sm:mx-6 px-3 py-3 rounded-lg bg-muted/50 border border-border/50">
        <p className="text-xs text-muted-foreground leading-relaxed">
          <span className="font-medium text-foreground/80">Note:</span> These responses are generated by the selected models, not by Zebvo AI. 
          Zebvo AI is not responsible for any inaccurate information, hallucinations, or mistakes that may appear in the responses. 
          For better accuracy, try multiple models and compare the results. Once you find the output you like, deselect the other models and use a single model consistently to get better results.
        </p>
      </div>
    </div>
