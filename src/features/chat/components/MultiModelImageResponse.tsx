...
export const MultiModelImageResponse = ({
  ...
  return <div className="w-full">
      ...
      <div ref={scrollRef} className="flex gap-4 overflow-x-auto scrollbar-hide stagger-cards" style={{
      ...
      {models.map(model => {
        ...
        return <div key={model} className={cn("flex-shrink-0 w-[280px] sm:w-[320px] md:w-[360px] rounded-xl border-2 overflow-hidden relative group", style.bg, style.border)}>
              ...
              <div className="p-2">
               ...
               </div> : <img src={imageUrl} alt={`Generated by ${model}`} className={`w-full ${aspectClass} object-cover rounded-lg shadow-md cursor-pointer hover:opacity-90 transition-opacity animate-image-reveal`} onClick={() => setLightboxImage({
              url: imageUrl,
              model
            })} onError={e => {
