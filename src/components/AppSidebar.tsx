...
export function AppSidebar() {
  ...
  return (
    <Sidebar 
      className={`hidden md:flex border-r border-border/10 dark:border-border/8 canvas-glass flex-col h-screen transition-[width] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
