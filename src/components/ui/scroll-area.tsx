...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    className={cn(
      // Keep scrollbar below overlay UI (like per-row action buttons)
    ...
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 rounded-full bg-border/60 transition-colors duration-150 hover:bg-border" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
));
