...
serve(async (req) => {
  ...
  try {
    // Only include models that are confirmed working:
    // - OpenAI: Direct API with OPENAI_API_KEY
    // - Anthropic: Direct API with ANTHROPIC_API_KEY  
    // - Gemini: Via Lovable AI Gateway (no quota issues)
    // Note: OpenRouter models removed - they require purchased credits
